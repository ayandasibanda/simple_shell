...
/**
 * struct passinfo - contain arguments to pass into function
 * allowing uniform prototypes for function pointer struct
 * @arg: an arr of arguements
 * @argv:an arr of strings from arg
 * @path:  path for command
 * @argc: number of arguments counted
 * @line_count: errors count
 * @err_num: errors numb for exit()
...
typedef struct passinfo
{
	...
	char **cmd_buf; /* pointer to cmd ; chain buffer, to manage memory */
